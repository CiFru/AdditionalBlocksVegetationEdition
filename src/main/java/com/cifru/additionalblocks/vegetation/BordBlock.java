...
public class BordBlock extends WallSignBlock implements IConfigObject {
    ...
    public BordBlock(String registryName, Supplier<Boolean> configValue, Block.Properties properties, Supplier<TileEntityType<?>> bordblock) {
    ...
    public BordBlock(String registryName, Block.Properties properties, Supplier<TileEntityType<?>> bordblock) {
        super(properties, WoodType.OAK);
        this.setRegistryName(registryName);
        this.enable = () -> true;
        this.tileEntityType = bordblock;
