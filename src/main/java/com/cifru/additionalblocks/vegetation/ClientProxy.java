...
import com.cifru.additionalblocks.vegetation.boat.VBoatEntityRenderer;
...
public class ClientProxy {
    ...
    public static void setup(FMLClientSetupEvent e){
        ...
        RenderingRegistry.registerEntityRenderingHandler(AdditionalBlocks.boat_entity, VBoatEntityRenderer::new);
    }
